...
class Jackandjill : AppCompatActivity() {
    var videoView: VideoView? = null
    var mediaController : MediaController? = null
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_jackandjill)
        ...
        videoView!!.setVideoURI(Uri.parse("android.resource://"+packageName+"/"+R.raw.jackandjill))
